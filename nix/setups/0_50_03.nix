{ pkgs }: let
    ...
    version = "0.50.03";
    src = pkgs.fetchzip {
        url = "https://github.com/MegaMek/megamek/releases/download/v0.50.03/MegaMek-0.50.03.tar.gz";
        hash = "sha256-vgQQUk9oG6hbh2gvLF4LApwCPcBxtGMvzYUwg6e9tCo=";
    };
    classpath = utils.classpath src [
        ...
        "lib/commons-collections4-4.5.0-M2.jar"
        "lib/commons-text-1.12.0.jar"
        "lib/commons-lang3-3.17.0.jar"
        "lib/log4j-core-2.24.0.jar"
        "lib/log4j-api-2.24.0.jar"
        "lib/freemarker-2.3.33.jar"
        "lib/commonmark-0.22.0.jar"
        "lib/sentry-log4j2-8.1.0.jar"
        "lib/sentry-8.1.0.jar"
